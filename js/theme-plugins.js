...
Segment.prototype = {
      ...
      !(function p() {
        ...
        return (
          ...
          r.begin < r.end
            ...
            : r.draw(r.begin + (r.end - r.begin), r.end - (r.end - r.begin)),
  ...
  valueOf: function (t) {
    ...
    if (("string" == typeof t || t instanceof String) && ~t.indexOf("%")) {
      var n;
      ~t.indexOf("+")
        ? ((n = t.split("+")), (e = this.percent(n[0]) + parseFloat(n[1])))
        : ~t.indexOf("-")
        ? ((n = t.split("-")), (e = this.percent(n[0]) - parseFloat(n[1])))
        : (e = this.percent(t));
    }
        ...
        if (!this.transitioning && !this.$element.hasClass("in")) {
          ...
          if (
            ...
            if ((this.$element.trigger(n), !n.isDefaultPrevented())) {
              i &&
                i.length &&
                (a.call(i, "hide"), e || i.data("bs.collapse", null));
...
!(function (t) {
  ...
  var i = ["Days", "Hours", "Minutes", "Seconds"],
    s = { Seconds: "Minutes", Minutes: "Hours", Hours: "Days", Days: "Years" },
    n = {
      Seconds: 1,
      Minutes: 60,
      Hours: 3600,
  ...
  (u.prototype.clearListeners = function () {
    ...
    (u.prototype.initialize = function (i) {
      ...
      0 === r && (r = t(this.element).height()),
        ...
        0 === r && o > 0
          ...
          : 0 === o && r > 0 && (o = r * this.data.drawn_units.length);
      ...
      for (var l in this.data.text_elements)
        if (this.config.time[l].show) {
          ...
          c.addClass("textDiv_" + l),
            c.css("top", Math.round(0.35 * this.data.attributes.item_size)),
    ...
    (u.prototype.update = function (t) {
      ...
      if (
        ...
        null === h && (h = d),
        !this.config.count_past_zero && d > this.data.attributes.ref_date)
      ) {
        ...
        for (var u in i) {
          l = i[u];
          if (
            (Math.floor(b.raw_time[l]) !== Math.floor(b.raw_old_time[l]) &&
            ...
            if (
              (Math.floor(_.raw_time[l]) !== Math.floor(_.raw_old_time[l]) &&
                this.notifyListeners(
                  l,
                  Math.floor(_.time[l]),
                  Math.floor(s),
              ...
              "smooth" === this.config.animation
                ? (null === g ||
                    a ||
                    (Math.floor(_.time[g]) > Math.floor(_.old_time[g])
                      ? (this.radialFade(c, f, m, 1, l),
                        (this.data.state.fading[l] = !0))
                      : Math.floor(_.time[g]) < Math.floor(_.old_time[g]) &&
                        (this.radialFade(c, f, m, 0, l),
                        (this.data.state.fading[l] = !0))),
                  this.data.state.fading[l] || this.drawArc(c, f, m, _.pct[l]))
                : this.animateArc(
                    c,
                    f,
                    m,
          ...
          if ("smooth" === this.config.animation)
            ...
            x < 0 && (x = 1e3 + x),
              ...
              (w.data.animation_frame = e.setTimeout(function () {
                w.data.animation_frame = e.requestAnimationFrame(
                  M,
                  w.element,
                  w
                );
    ...
    (u.prototype.animateArc = function (t, a, i, s, n, r) {
      if (null !== this.data.attributes.context) {
        var o = n - s;
        if (Math.abs(o) > 0.5)
          0 === s ? this.radialFade(t, a, i, 1) : this.radialFade(t, a, i, 0);
        else {
    ...
    (u.prototype.drawArc = function (t, e, i, s) {
      if (null !== this.data.attributes.context) {
        ...
        a || this.data.attributes.context.clearRect(t - h, e - h, 2 * h, 2 * h),
    ...
    (u.prototype.start = function () {
      ...
      if (
        ...
        this.data.attributes.ref_date = (function (t) {
          ...
          var n = Date.parse(t);
          return isNaN(n)
            ? ((n = Date.parse(t.replace(/-/g, "/").replace("T", " "))),
              isNaN(n) ? new Date() : n)
            : n;
        })(a);
        ...
        void 0 === i && (i = t(this.element).attr("data-timer")),
          ...
          "number" == typeof i
            ? ((this.data.timer = i),
              (this.data.attributes.ref_date = new Date().getTime() + 1e3 * i))
    ...
    share: function () {
      var t = this.getValue("sharer").toLowerCase(),
        e = {
          ...
          twitter: {
            shareUrl: "https://twitter.com/POPEYE/intent/tweet/",
            params: {
